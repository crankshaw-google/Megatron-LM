...
def recv_forward(tensor_shape: Shape, config: ModelParallelConfig, component_connector_group_index: int = 0) -> torch.Tensor:
...
@nvtx.annotate(color="blue", category="p2p_op")
def recv_backward(tensor_shape: Shape, config: ModelParallelConfig, component_connector_group_index: int = 0) -> torch.Tensor:
...
@nvtx.annotate(color="blue", category="p2p_op")
def send_forward(output_tensor: torch.Tensor, config: ModelParallelConfig, component_connector_group_index: int = 0) -> None:
...
@nvtx.annotate(color="blue", category="p2p_op")
def send_backward(input_tensor_grad: torch.Tensor, config: ModelParallelConfig, component_connector_group_index: int = 0) -> None:
...
def send_forward_recv_backward(
    output_tensor: torch.Tensor, tensor_shape: Shape, config: ModelParallelConfig, component_connector_group_index: int = 0
) -> torch.Tensor:
...
def send_backward_recv_forward(
    input_tensor_grad: torch.Tensor, tensor_shape: Shape, config: ModelParallelConfig, component_connector_group_index: int = 0
) -> torch.Tensor:
